...
export class Regatron {
    ...
    private gerenciadorTemperatura1 = new GerenciadorTemperatura(
        this.termometro1,
        this.arCondicionado1
    );

    private arCondicionado2 = new ArCondicionado();
    private termometro2 = new Termometro();
    private gerenciadorTemperatura2 = new GerenciadorTemperatura(
        this.termometro2,
        this.arCondicionado2
    );
    ...
    private gerenciadorTemperatura3 = new GerenciadorTemperatura(
        this.termometro3,
        this.arCondicionado3
    );
    ...
    private gerenciadorLuminosidade1 = new GerenciadorLuminosidade(
        this.fotoSensor1,
        this.lampada1,
        this.cobertor1
    );
    ...
    private gerenciadorLuminosidade2 = new GerenciadorLuminosidade(
        this.fotoSensor2,
        this.lampada2,
        this.cobertor2
    );
    ...
    private gerenciadorLuminosidade3 = new GerenciadorLuminosidade(
        this.fotoSensor3,
        this.lampada3,
        this.cobertor3
    );
    ...
    private gerenciadorAgua1 = new GerenciadorAgua(
        this.regador1,
        this.balanca1
    );
    ...
    constructor(database: RegatronService) {
        ...
        this.database.salvarVaso(
            new Vaso({
                descricao: "Vaso Vermelho",
                gerenciadorTemp: this.gerenciadorTemperatura2,
