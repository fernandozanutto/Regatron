    ...
    bindViewEvents(): void {
        ...
        if (buttonPlanta) {
            buttonPlanta.addEventListener("click", () => {
                this.onPlantaButtonClick();
            });
        }

        if (buttonVaso) {
            buttonVaso.addEventListener("click", () => {
                this.onVasoButtonClick();
            });
        }

        this.plantas.forEach((planta) => {
            const buttonPlanta = document.getElementById(
                `button-verplanta-${planta.id}`
            );
            if (buttonPlanta) {
                buttonPlanta.addEventListener("click", () => {
